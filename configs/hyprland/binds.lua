...
hl.bind(modifier .. " + CTRL + L", hl.dsp.exec_cmd("swaylock"))
hl.bind(modifier .. " + Return", hl.dsp.exec_cmd("foot"))
hl.bind(modifier .. " + P", hl.dsp.exec_cmd("fuzzel"))

hl.bind(modifier .. " + V", hl.dsp.window.float({ action = "toggle" }))
hl.bind(modifier .. " + F", hl.dsp.layout("colresize 1"))
...
hl.bind(modifier .. " + mouse_up", hl.dsp.focus({ workspace = "+1" }))
hl.bind(modifier .. " + mouse_down", hl.dsp.focus({ workspace = "-1" }))
hl.bind(modifier .. " + SHIFT + mouse_up", hl.dsp.focus({ direction = "right" }))
hl.bind(modifier .. " + SHIFT + mouse_down", hl.dsp.focus({ direction = "left" }))
